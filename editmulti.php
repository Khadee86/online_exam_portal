...
<div class="purple-gradient">
    <div class="row login_box purple-gradient">  
        <div class="col-md-12 col-xs-12 login_control">
                <div class="font">
                        <div class="control">
                            <button type='submit' class="btn purple-gradient " name="editquest">Edit Question</button>
                        </div>
                <div class="control">
                    <button type='submit' class="btn purple-gradient" name="A">Edit option A</button>  
                </div>
                <div class="control">
                    <button type='submit' class="btn purple-gradient" name="B">Edit option B</button>  
                </div>
                <div class="control">
                    <button type='submit' class="btn purple-gradient" name="C">Edit option C</button>  
                </div>
                <div class="control">
                    <button type='submit' class="btn purple-gradient" name="D">Edit option D</button>  
                </div>
                <div class="control">
                    <button type='submit' class="btn purple-gradient" name="E">Edit option E</button>  
                </div>
                <div class="control">
                    <button type='submit' class="btn purple-gradient" name="Answer">Edit correct answer</button>  
                </div>
