...
$sql="UPDATE multiple_choice SET Question='$Question' WHERE registered_user='$_SESSION[username]' AND quiz_title = '$title' AND Quiz_number = '$num' AND quiz_type ='multiple_choice'";
