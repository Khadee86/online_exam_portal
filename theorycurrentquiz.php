<?php
   ...
   if(isset($_POST['Delete'])){
    $query="DELETE FROM quizzz WHERE username='$_SESSION[username]' AND  quiz_name='$_SESSION[quiz]'AND quiz_type='theory'";
       if($conn->query($query)===TRUE){
        echo "\nitem deleted successfully"."<br>";
       $sql="DELETE FROM multiple_choice WHERE registered_user='$_SESSION[username]' AND  quiz_title='$_SESSION[quiz]'AND quiz_type='theory'";
...
$query="SELECT quiz_title,Quiz_number,Question,mark,quiz_type FROM multiple_choice WHERE registered_user='$_SESSION[username]' AND  quiz_title='$_SESSION[quiz]'AND quiz_type='theory' ";
