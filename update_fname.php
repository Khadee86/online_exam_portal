...
$sql="UPDATE register SET firstname='$firstname' WHERE username='$_SESSION[username]'";
...
if(mysqli_query($conn, $sql))
{
    ...
    echo "could not update your first name<br>";
}
                    ...
                    <div class="col-md-8">
                            <div class="card">
                                <div class="card-header purple-gradient">
                                    <strong style='color:white;'>UPDATE FIRST NAME</strong>
                                </div>
                                <div class="card-body">
                                    <form name=>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 offset-md-4">
                                                    ...
                                                    <input type="submit" name="submit" class="btn purple-gradient" value='update first name'>
