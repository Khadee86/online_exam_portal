...
$sql="UPDATE multiple_choice SET Question='$Question' WHERE registered_user='$_SESSION[username]' AND quiz_title ='$title' AND Quiz_number ='$num' AND quiz_type = '$type'";
                    ...
                    <div class="col-md-8">
                            <div class="card">
                                <div class="card-header purple-gradient">
                                    <strong style='color:white;'>Edit Theory/ Fill</strong>
                                </div>
                                <div class="card-body">
                                    <form name=>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="" class="form-control" name="Question">
                                            </div>
                                        </div>
                                </div>     
                                <div class="card-body">   
                                ...
                                <div class="card-body">        
                                        <div class="form-group row">
                                            <label for="quiz type" class="col-md-4 col-form-label text-md-right">Quiz Type</label>
                                            <div class="col-md-6">
