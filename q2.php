 ...
 //include "q_table.php";
    ...
    if(isset($_POST['submit']))
    {
        ...
        $quiz_text=$_POST['quiz_text'];
         ...
         $query="INSERT INTO quizzz(username,quiz_name,quiz_type,quiz_code)VALUES('$_SESSION[username]','$_SESSION[quiz_text]','$_SESSION[theory]','$code') ";
         if ($conn->query($query) === TRUE){
             $_SESSION['code']=$code;
            header('location:th_questions.php');
              }   
            else {
...
<div class="jumbotron text-center blue-grey lighten-5 jumbtron-wrap">
  <h1 class="text1 purple-gradient">THEORY QUESTIONS</h1>
