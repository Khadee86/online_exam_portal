...
<!doctype html>
<head>
    <title>View theory Quiz|Admin</title>
...
<?php
$query="SELECT quiz_title,Quiz_number,Question FROM multiple_choice WHERE registered_user='$_SESSION[username]' AND quiz_title='$_SESSION[quiz_text]' AND quiz_type='$_SESSION[theory]'";
